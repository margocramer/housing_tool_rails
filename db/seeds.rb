...
UnitRent.create!(household_income: HouseholdIncome.fourth, bedrooms:"micro", monthly_rent:1116)
UnitRent.create!(household_income: HouseholdIncome.fourth, bedrooms:"studio", monthly_rent:1241)
UnitRent.create!(household_income: HouseholdIncome.fourth, bedrooms:"1", monthly_rent:1447)
UnitRent.create!(household_income: HouseholdIncome.find(5), bedrooms:"micro", monthly_rent:1395)
UnitRent.create!(household_income: HouseholdIncome.find(5), bedrooms:"studio", monthly_rent:1551)
UnitRent.create!(household_income: HouseholdIncome.find(5), bedrooms:"1", monthly_rent:1810)
UnitRent.create!(household_income: HouseholdIncome.find(6), bedrooms:"micro", monthly_rent:1675)
UnitRent.create!(household_income: HouseholdIncome.find(6), bedrooms:"studio", monthly_rent:1862)
UnitRent.create!(household_income: HouseholdIncome.find(6), bedrooms:"1", monthly_rent:2172)
